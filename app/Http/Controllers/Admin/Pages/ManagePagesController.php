        ...
        if ($is_associated) {
            if ($page_edit->sections()->find($page_section->id)) {
                return Response::json([
                    ...
                    'error' => ["La sección ya se encuetra previamente asociada"]
                ], 422);
            }
            ...
            if (!$page_edit->sections()->save($page_section)) {
                return Response::json([
                    ...
                    'error' => ["La sección no pudo ser asociada"]
                ], 422);
            }


            $mesaje = ["Sección asociada correctamente."];
        }else{
            if (!$page_edit->sections()->detach($page_section)) {
                return Response::json([
                    ...
                    'error' => ["La sección no pudo ser desasociada"]
                ], 422);
            }

            $mesaje = ["Sección desasociada correctamente."];
        }
