...
$style = [
    ...
    'button--yellow' => 'background-color: #000;color: #fff;font-weight: normal;',
                    ...
                    <tr>
                        <td style="{{ $style['email-masthead'] }}">
                            <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                <img src="{{ asset('images/ambienta-logo.png')}}" alt="{{ config( 'app.name') }}" style="max-width: 200px;display: block;margin: 0 auto;margin-bottom: 10px;width:100%;">
                            </a>
                        </td>
                    </tr>
