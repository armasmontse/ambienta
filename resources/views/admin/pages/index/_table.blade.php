        ...
        @foreach ($pages as $page_edit)
            <tr class="">
                ...
                <td class="center-align" >
                    <a href="{{ $page_edit->edit_url }}" class="btn-floating waves-effect waves-light black">
                ...
                <td class="center-align">
                    @unless ($page_edit->main)
                        {!! Form::open([
                            ...
                            <button type="submit" class=" btn-floating waves-effect waves-light red darken-3" form ="delete_page-{{$page_edit->id}}_form">
