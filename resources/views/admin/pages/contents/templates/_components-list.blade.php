    ...
    <li v-for="component in sortable_list" style="margin-top: 5%;">
        <div class="collapsible-header">
            ...
            <div class="pull-left" v-if="section.type.sortable && sortable_list.length > 1" style="margin-top: 10px;">
                <span class="btn-floating waves-effect waves-light black" @click.stop="move(-1, $index, sortable_list)">
            ...
            <div class="pull-right" v-if="section.type.unlimited" style="margin-top: 10px;">
                {!! Form::open([
              		...
              		<button type="submit" class=" btn-floating waves-effect waves-light red darken-3" form ="delete_compoment-&#123;&#123; component.id &#125;&#125;_form" @click.stop="">
