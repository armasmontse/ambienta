            ...
            <tbody class="">
                <tr :class="index"  v-for="page in sortable_list" >
                    ...
                    <td  class="center-align" >
                        <a href="@{{ page.public_url }}" class="btn-floating waves-effect waves-light black" target="_blank">
                            <i class="material-icons small">input</i>
                        </a>
                    </td>
                    <td class="center-align" >
                        <a href="@{{ page.edit_content_url }}" class="btn-floating waves-effect waves-light black">
