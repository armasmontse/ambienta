    ...
    <div class="col s10">
        ...
        {!! Form::open([
            ...
            @foreach ($languages as $language)
                ...
                {!! Form::label('title[' . $language->iso6391 . ']', 'Título:', ['class' => 'active']) !!}
                ...
                {!! Form::label('description[' . $language->iso6391 . ']', 'Descripción', ['class' => 'active']) !!}
                ...
                @include('admin.seo_manager._googleSearchResults', [
                    'model' => $seoable,
