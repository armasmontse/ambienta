            ...
            <tr class="">
                ...
                <td class="center-align">
                    ...
                    @if (!$user_edit->hasNoRoles())
                        <a href="{{ route( 'admin::users.edit', [$user_edit->id] ) }}" class="btn-floating black">
                ...
                <td class="center-align">
                    ...
                    @if( $user_edit->id != $user->id )
                        {!! Form::open([
                            ...
                            <button type="submit" class=" btn-floating waves-effect waves-light red darken-3" form ="delete_user-{{$user_edit->id}}_form">
