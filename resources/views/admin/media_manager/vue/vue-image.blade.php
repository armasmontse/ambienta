<div class="mt-5 image__col--@{{type}} image__col camera-blue handle singleImage--@{{parent_ref}}_JS" :data-id="image.id">
	<slot name="title"></slot>
	<slot name="description"></slot>
	<div class="image--@{{type}}">
		<div class="image--@{{type}}__aspect-ratio-container h-inherit w-inherit flex">
			<div class="image__inline-block-container media-manager--img-align" v-bind:class="{
				'h-100': !image.src,
				'w-100': !image.src
			}">
				<div  v-on:click="initAddMediaProcess(media_manager, $event)">
					...
					<div v-if="image.src" class="image__image-remove">
						...
						{!! Form::hidden("order", null, [
							...
							<button form="disassociate_photos-&#123;&#123;printable_ref&#125;&#125;_form" class=" btn-floating waves-effect waves-light black image__image-remove--button" type="submit">
					...
					<div  v-if="!image.src" class="image__icon-container">
						<div class="media-manager--trigger">
							<span class="fa fa-camera media-manager__icon-camera blue-creel"></span>
