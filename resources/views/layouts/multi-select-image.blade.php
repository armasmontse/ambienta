	   ...
	   'v-on:submit.prevent'   => 'post'
		 ...
		 <div class="submenu submenu_JS" v-on:click="openMultiSelect()" style="position: relative">
			 ...
			 <div class="submenu-container container-items_JS" >
				 <div class="container-item" v-for="item in list">
			         ...
			         <label class="align-images" :for="'{{$select_plural}}_'+item.{{ $option_value }}">&#123;&#123; item.{{ $option_label }} &#125;&#125;<img :src="item.thumbnail_image.url" alt="" style="width:50px;height:50px;"></label>
			     </div>
			 </div>
		 </div>
		...
		<br><br><br>
            <div class="pull-right">
                {!! Form::submit("Guardar", [
                    'class' => 'btn waves-effect waves-light black flex-collapsible ',
                    'form'  => $form_id
                ]) !!}
            </div>
        </div>
